            ...
            if(code == HC_ACTION) {
                ...
                if(CharIntercepted != null
                    ...
                    if(llh.vkCode == (int)Keys.ShiftKey
                        ...
                        CharIntercepted(
                            msg, "" + (llh.vkCode == (int)Keys.Space ? currentDeadChar : '\x01'), true,
                        ...
                        CharIntercepted(msg, buff.ToString(), false, llh.vkCode, llh.scanCode, llh.flags, llh.time, llh.dwExtraInfo);
                    }
                }
            }
