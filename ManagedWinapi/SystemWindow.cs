...
namespace ManagedWinapi.Windows {
    ...
    public class SystemWindow {
        ...
        public static SystemWindow[] FilterToplevelWindows(Predicate<SystemWindow> predicate) {
            ...
            EnumWindows(
                new EnumWindowsProc(delegate (IntPtr hwnd, IntPtr lParam) {
        ...
        /// <summary>
        /// The window's parent, but only if this window is its parent child.
        /// Some parents, like dialog owners, do not have the window as its child.
        /// In that case, <c>null</c> will be returned.
        /// </summary>
        ...
        /// Use <see cref="Position"/> if you want to use the relative position.
        /// </summary>
        ...
        /// function and use the <see cref="SystemWindow.Rectangle"/> property for the range.
        /// </summary>
        public Image Image {
            get {
        ...
        /// a text field. May be used for different purpose by other controls.
        /// </summary>
        ...
        /// </summary>
        /// <param name="clientAreaOnly">Whether to get the context for the client area or for the full window.</param>
