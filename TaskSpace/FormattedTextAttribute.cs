...
namespace TaskSpace {
    public class FormattedTextAttribute {
        public static readonly DependencyProperty FormattedTextProperty = DependencyProperty.RegisterAttached(
            ...
            new UIPropertyMetadata(string.Empty, FormattedTextChanged)
        );
        ...
        private static void FormattedTextChanged(
            ...
            formattedText = @"<Span xml:space=""preserve"" xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"">"
                + formattedText
                + "</Span>";
