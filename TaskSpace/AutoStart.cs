...
namespace TaskSpace {
    ...
    public class AutoStart {
        ...
        private static string GetAppLinkPath() {
            string appDataStart = Path.Combine(
                Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData),
                @"Microsoft\Windows\Start Menu\Programs\Startup"
            );

            string appLink = Path.Combine(appDataStart, "TaskSpace.lnk");
            return appLink;
        }
        ...
        private static void DeleteShortcut(string appLink) {
            try {
                ...
                throw new AutoStartException("It was not possible to delete the shortcut to TaskSpace in the startup folder.");
            }
        }
        ...
        private static void CreateShortcut(string appLink) {
            try {
                ...
                throw new AutoStartException("It was not possible to create a shortcut to TaskSpace in the startup folder.");
            }
        }
    }
