#define MyAppName "TaskSpace"
#define MyAppPublisher "Regin Larsen"
#define MyAppURL "http://www.todo.com"
#define MyAppExeName "TaskSpace.exe"
#define MyAppPath SourcePath + "ProgramFiles"
#define MyAppVer = GetFileVersion(MyAppPath + "\TaskSpace.exe")

[Setup]
AppId={{A5AF4C34-70A7-4D3B-BA18-E49C0AEEA5E6}
AppMutex=DBDE24E4-91F6-11DF-B495-C536DFD72085-TaskSpace
AppName={#MyAppName}
...
OutputBaseFilename=TaskSpace-setup
Compression=lzma
